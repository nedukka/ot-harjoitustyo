...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_voi_ostaa_edullisen_lounaan_kun_saldo_on_tasan_syo_edullisesti_hinta(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_voi_ostaa_maukkaan_lounaan_kun_saldo_on_tasan_syo_maukkaasti_hinta(self):
