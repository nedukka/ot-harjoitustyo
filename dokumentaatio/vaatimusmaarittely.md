...
- Käyttäjä voi lisätä uusia tehtäviä (tehty)
- Tehtäville määritetään: (tehty)
  - nimi
  - tehtävätyyppi
- Tehtävätyypit ovat:
...
- Käyttäjä pystyy poistamaan tehtäviä (tehty)
- Käyttäjä pystyy näkemään tehdyt tehtävät viikon loppuun asti (tehty)

### Tehtävien tarkastelu ja suodatus

- Käyttäjä pystyy tarkastelemaan kaikkia tehtäviään yhdessä näkymässä (tehty)
- Käyttäjä pystyy suodattamaan näkyviä tehtäviä valitsemalla motivaatiotason (tehty)
- Motivaatiotasot ja näkyvät tehtävät: (tehty)
